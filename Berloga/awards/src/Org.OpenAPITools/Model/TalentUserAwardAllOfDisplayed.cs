...
{
    /// <summary>
    /// TalentUserAwardAllOfDisplayed
    /// </summary>
    [DataContract(Name = "TalentUserAward_allOf_displayed")]
    public partial class TalentUserAwardAllOfDisplayed : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TalentUserAwardAllOfDisplayed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TalentUserAwardAllOfDisplayed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TalentUserAwardAllOfDisplayed" /> class.
        /// </summary>
        /// <param name="applicationId">Идентификатор приложения. (required).</param>
        /// <param name="displayedAt">displayedAt (required).</param>
        public TalentUserAwardAllOfDisplayed(Guid applicationId = default(Guid), DateTime displayedAt = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TalentUserAwardAllOfDisplayed {\n");
