...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Instrument : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Instrument" /> class.
        /// </summary>
        /// <param name="id">Идентификатор инструмента. (required).</param>
        ...
        /// <param name="isActive">Активен ли инструмент. (required).</param>
        public Instrument(int id = default(int), int traditionId = default(int), int competencyId = default(int), string name = default(string), string image = default(string), string description = default(string), bool isActive = default(bool))
        {
            this.Id = id;
            ...
            if (image == null)
            {
                throw new ArgumentNullException("image is a required property for Instrument and cannot be null");
            }
            this.Image = image;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for Instrument and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Идентификатор инструмента.</value>
        ...
        /// </summary>
        /// <value>Активен ли инструмент.</value>
