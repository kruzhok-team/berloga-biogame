...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Award : IValidatableObject
    {
        ...
        public Award(int id = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), int traditionId = default(int), int instrumentId = default(int), int awardLevel = default(int), int dependencyLevel = default(int), decimal requiredScores = default(decimal), string name = default(string), string description = default(string), string iconUrl = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Award and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for Award and cannot be null");
            }
            this.Description = description;
            // to ensure "iconUrl" is required (not null)
            if (iconUrl == null)
            {
                throw new ArgumentNullException("iconUrl is a required property for Award and cannot be null");
            }
